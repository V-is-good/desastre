...
from prettytable import PrettyTable  # Asegúrate de tener esta biblioteca instalada
...
print()
print(Fore.YELLOW + " " * 2 + " HERRAMIENTA DE DEESASTRE")
print(menu)
try:
	while True:
		parametros = input(Fore.MAGENTA + "  DESASTRE.PY ═> " + Fore.WHITE)
		if parametros == "1":
			SearchEmail()
		elif parametros == "2":
			searchUserName()
